...
/**
 * Returns the letter grade (A, B, C, D, or F) for a given score.
 *
 * If the score is outside the valid range of 0-100, returns null so
 * that main() can detect it and print an appropriate error message.
 */
